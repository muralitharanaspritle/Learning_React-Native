...
class MonthDateYearField extends _react.default.Component {
  constructor(...args) {
    super(...args);
    ...
    _defineProperty(this, "onBlur", () => {
      ...
      if ((0, _utils.int)(current.date) === 0) {
        current.date = '01';
      }
...
_defineProperty(MonthDateYearField, "defaultProps", {
  labelDate: 'Date',
  labelMonth: 'Month',
  labelYear: 'Year',
  editable: true
...
var _default = MonthDateYearField;
exports.default = _default;
//# sourceMappingURL=MonthDateYearField.js.map